<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <%
 	String use_phone = (String)request.getAttribute("USE_PHONE");
...
<body>
	...
	<form action="">
	<label>아이디<br>
	<input type="text" name = "ID"value = "<%=use_id%>" placeholder="최대 20자까지 입력 가능(단,한글 안됨)"required>
	<input type="button" value="중복확인" onclick = "location.href='LogCheckServlet?input_id='+ID.value"><br>
	<br>
	
	<label>비밀번호</label><br>
	<input type="password" name = "PW" pattern = "[a-z0-9_]*"placeholder="최대 20자까지 입력 가능(단,한글 안됨)"><br>
	
	<label>비밀번호 재확인</label><br>
	<input type="password" name = "PW" pattern = "[a-z0-9_]*">
	<br>
	...
	<label>성별</label><br>
	<input type = "text" name = "gen" list = "gen"/>
	<datalist id = "gen">
	...
	<br>
	<input type="text" name="PHONE" value = "<%=use_phone%>" pattern = "[-0-9]*" placeholder="전화번호 입력">
	<input type="button" value="중복확인" onclick = "location.href='LogCheck?input_phone='+PHONE.value"><br>
	<tr><td><%=result%></td></tr>
	
	<br>
	<input type="submit" size = "150" value="가입하기" >
