...
<body>
	<form action="AgreementCheck" method="get">
<table>
<fieldset style = "width: 500px; height : 800px;" >
<input type = "checkbox" value = "1" name="checkbox1" >네이버 이용 동의 약관 동의(필수)
<textarea rows="30px" cols="40px" readonly="readonly">
여러분을 환영합니다.
...
공지 일자: 2018년 3월 30일
적용 일자: 2018년 5월 1일
네이버 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.</textarea>
<br>
	
<input type = "checkbox" value = "1" name="checkbox2" >개인정보 수집 및 이용에 대한 안내(필수)
<br>
	
	
<input type = "checkbox" value = "1" name="checkbox3">위치정보 이용약관 동의(선택)
<br>
	

<input type = "checkbox" value = "1" name="checkbox4">이벤트 등 프로모션 알림 메일 수신(선택)
<br>
	
<input type="submit" size = "50" name = "YES" value="확인">
<input type="reset" size = "50" name ="NO" value="취소">
