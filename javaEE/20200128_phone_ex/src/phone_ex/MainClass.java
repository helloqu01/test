...
public class MainClass {
	...
	public static void main(String[] args) {//8번 
		...
		//<Object>() 예약타입으로 써도 되나 반드시  SamsungClass s1=(SamsungClass)obj.get(0);
		//(형변환)을 시켜줘야 선언된 변수들을 사용 할 수 있다. 
		
		ArrayList<phone> phones = new ArrayList<phone>();
		phones.add(s);
		phones.add(lg);
		phones.add(iphone);
		//<phone>(); 로 선언하면  get(0).call 등의 변수를 불러와서 사용 할 수 있다(형변환 시킬 필요가 없다.) 
